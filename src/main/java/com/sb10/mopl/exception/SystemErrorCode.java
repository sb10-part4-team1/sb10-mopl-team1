...
/**
 * 특정 도메인에 속하지 않고, 스프링 프레임워크나 자바 런타임 자체에서 발생하는
 * 공통 시스템 에러 코드를 정의한 Enum 클래스입니다.
 */
public enum SystemErrorCode implements ErrorCode {
  ...
  INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "SYS99", "서버 내부 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.");
